define([
  ...
  function(declare, _WidgetsInTemplateMixin, BaseWidget, on, keys, Deferred, dojoI18n, esriNlsBundle,
    ...
    OperationBase, GraphicsLayer, FeatureLayer,  graphicsUtils, ViewStack, jimuUtils, ToggleButton, wkidUtils, LayerInfos,
      LoadingIndicator) {
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      _labelLayer: null,
	  //Changes -- Begin 
	  _mp: null, //Variable to store map reference
	  _grphcs: null, //Variable to store extent of graphics
	  //Changes -- End
      ...
      _pushAddOperation: function(graphics){
        ...
        this._undoManager.add(addOperation);
		 ...
		 //Changes -- Begin
		 _grphcs = graphicsUtils.graphicsExtent(this._graphicsLayer.graphics);
		 this.map.setExtent(_grphcs);
		 //Changes -- End
      },
